...
class RiskProfilingModel:
    ...
    def train(self, df):
        ...
        output_path = DATA_DIR / "customer_risk_output.csv"
...
if __name__=="__main__":
    ...
    df = risk_model.load_data(
        str(DATA_DIR / "customerinfo.csv"),
        str(DATA_DIR / "customerbehavior.csv")
    )
    
    # Train and save
    risk_model.train(df)
    risk_model.save_model(str(MODELS_DIR / 'risk_model.pkl'))
